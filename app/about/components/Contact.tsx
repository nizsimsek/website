...
import { RiArrowDownSFill, RiArrowRightSFill, RiMailFill } from "react-icons/ri";
        ...
        <div className="flex flex-col h-auto">
            ...
            {show && (
                <div className="flex flex-col px-4 py-1 lg:pb-4">
                    <Link href="mailto:nizsimsek@gmail.com" className="flex items-center h-8 text-cl-muted hover:text-white">
                        <RiMailFill />
                        <span className="ml-1">nizsimsek@gmail.com</span>
                    </Link>
                    <Link href="https://linkedin.com/in/nizsimsek" className="flex items-center h-8 text-cl-muted hover:text-white">
                        <ImLinkedin2 />
